...
def test_insert_one():
    """测试 mongoDB 插入一条数据"""
    mongodb = MongoDbBase(**MONGODB_CONFIG)
    insert_res = mongodb.insert_one("test", {"name": "标题名称", "addtime": "2020-07-25", "adduser": "mine"})
...
def test_upload():
    ...
    # 返回上传后的 ID 及图片链接
    mongo_upload_id, image_id = mongodb.upload(file_name="test2.jpg",  _id="121212121213", content_type=content_type, collection="fs", file_data=r.content)
